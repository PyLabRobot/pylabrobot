...
class BenchCel4RBackend(StackerBackend):
  ...
  capability (not the random-access :class:`~pylabrobot.storage.Incubator`), and this backend
  implements the :class:`~pylabrobot.storage.stacker_backend.StackerBackend` transfers
  ...
  async def set_labware(
    ...
    *,
    ...
    :class:`~pylabrobot.storage.agilent.benchcel_labware.BenchCelLabwareSettings`
