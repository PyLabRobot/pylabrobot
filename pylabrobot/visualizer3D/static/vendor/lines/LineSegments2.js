...
// LOCAL CHANGE (not upstream): the default material is dropped. `LineMaterial` is a
// `ShaderMaterial` and imports `ShaderLib`, which the WebGPU build does not export, so importing
// it here breaks the whole module on that path. A material is always passed in, so the default
// was never used.
...
class LineSegments2 extends Mesh {
	 ...
	 */
	constructor( geometry = new LineSegmentsGeometry(), material ) {
