...
class SyringeDispenser:
  """Syringe dispenser for the BioTek EL406."""
  ...
  async def dispense(
    ...
    Args:
      ...
      offset_z: Z offset in mm (33.6 for 96-well, 25.4 for 1536-well).
  ...
  async def _syringe_dispense(
    ...
    logger.info(
      "Syringe dispense: %.1f uL from syringe %s, flow rate %d", volume, syringe, flow_rate
    )
  ...
  async def prime(
    ...
    Args:
      ...
      submerge_tips: Submerge tips in fluid after prime.
