"""The MultiFlo, a dispenser with syringes and two peristaltic pumps."""
...
This is the oldest firmware in the family. It predates dispensing into individually chosen wells,
and cannot store the fields for it, so such a step is refused rather than run across the whole
plate."""


class MultiFlo:
  """A MultiFlo dispenser.
  ...
  Attributes:
    ...
    peristaltic_dispenser: The peristaltic pumps.
  """

  family: ClassVar[InstrumentFamily] = InstrumentFamily.MULTIFLO
