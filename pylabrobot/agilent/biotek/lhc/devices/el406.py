"""The EL406, a washer-dispenser with a wash manifold, syringes and one peristaltic pump."""
...
class EL406:
  """An EL406 washer-dispenser.

  What the instrument can do is reached through the capability objects it exposes:
  :attr:`washer` for the wash manifold, :attr:`syringe_dispenser` for the syringes and
  :attr:`peristaltic_dispenser` for the pump. All three are always there; whether a particular
  operation can run depends on what the instrument reports as fitted, which :meth:`setup` reads and
  :meth:`get_available_steps` reports.
  ...
  Attributes:
    ...
    peristaltic_dispenser: The peristaltic pump.
  """

  family: ClassVar[InstrumentFamily] = InstrumentFamily.EL406
