"""CytationMicroscopyBackend — MicroscopyBackend for the Cytation.
...
Uses the BioTekBackend's serial connection (send_command) for optics commands.
...
class CytationMicroscopyBackend(MicroscopyBackend):
  """MicroscopyBackend for the Cytation.

  Owns the AravisCamera and all imaging state. Uses the BioTekBackend's
  serial connection for optics commands.
  """
