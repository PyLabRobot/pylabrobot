...
from pylabrobot.sila.discovery import (
  SiLADevice,
  _decode_nbns_name,
  _discover_sila2,
...
class TestDiscoverSila2(unittest.TestCase):
  @patch("pylabrobot.sila.discovery.HAS_ZEROCONF", False)
  def test_no_zeroconf_returns_empty(self):
    devices = asyncio.run(_discover_sila2(timeout=0.1))
    self.assertEqual(devices, [])

  @patch("pylabrobot.sila.discovery.HAS_ZEROCONF", True)
  @patch("pylabrobot.sila.discovery.Zeroconf")
  @patch("pylabrobot.sila.discovery.ServiceBrowser")
