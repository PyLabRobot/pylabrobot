...
def plate_to_pla_params(plate: Plate) -> dict:
  ...
  # Get max_volume from first well (in uL)
  first_well = plate.get_well("A1")
  well_max_volume_ul = first_well.max_volume
  ...
  if well_max_volume_ul > MAX_VOLUME_TENTHS_UL / 10:
    raise ValueError(
      f"Well max volume {well_max_volume_ul} uL exceeds Multidrop limit of "
