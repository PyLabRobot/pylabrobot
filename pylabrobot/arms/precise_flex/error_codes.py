ERROR_CODES = {
  0: {
    "text": "Success",
    "description": "Operation completed successfully without an error."
  },
  1: {
    "text": "Warning",
...
Older GPL systems may display the license number shown above in ( ) rather than the name. The currently installed licenses can be viewed via the web interface by selecting Utilities>Controller Options or by accessing DataID 112, "Software license option bits".  To obtain a required license, contact your system administrator or Brooks."""
  ...
  -223: {
    "text": "Incompatible system",
    "description": ""
  },
  -224: {
    "text": "FPGA load failed",
    "description": ""
  },
  ...
  -305: {
    "text": "Logical device already in use",
    "description": ""
  },
  -306: {
    "text": "Duplicate logical device",
    "description": ""
  },
  -307: {
    "text": "Duplicate physical device",
    "description": ""
  },
  -308: {
  ...
  -313: {
    "text": "CANOpen driver initialization failure",
    "description": ""
  },
  -314: {
  ...
  -721: {
    "text": "Conflict with reserved keyword",
    "description": ""
  },
  -722: {
  ...
  -1513: {
    "text": "Invalid data from callback routine",
    "description": ""
  },
  -1514: {
  ...
  -1525: {
    "text": "Servo network not allowed with EtherCAT",
    "description": ""
  },
  -1526: {
    "text": "EtherCAT configuration mismatch",
    "description": ""
  },
  -1527: {
    "text": "EtherCAT object not supported",
    "description": ""
  },
  -1528: {
    "text": "Too many EtherCAT slaves",
    "description": ""
  },
  -1550: {
  ...
  -1751: {
    "text": "EtherCAT slave not responding",
    "description": ""
  },
  -1752: {
    "text": "EtherCAT synchronous message timeout",
    "description": ""
  },
  -1753: {
    "text": "EtherCAT slave not ready",
    "description": ""
  },
  -1754: {
    "text": "EtherCAT disabled",
    "description": ""
  },
  -2101: {
  ...
  -3004: {
    "text": "Servo not initialized",
    "description": ""
  },
  -3005: {
    "text": "Servo mode transition failed",
    "description": ""
  },
  -3006: {
    "text": "Servo mode locked",
    "description": ""
  },
  -3007: {
    "text": "Servo hash table not found",
    "description": ""
  },
  -3008: {
    "text": "Servo hash entry collision",
    "description": ""
  },
  -3009: {
    "text": "No hash entry found",
    "description": ""
  },
  -3010: {
    "text": "Servo hash table full",
    "description": ""
  },
  -3011: {
    "text": "Illegal parameter access",
    "description": ""
  },
  -3012: {
  ...
  -3013: {
    "text": "Servo task submission failed",
    "description": ""
  },
  -3014: {
  ...
  -3116: {
    "text": "Precise encoder index error",
    "description": ""
  },
  -3117: {
  ...
  -3150: {
    "text": "Position compare not enabled",
    "description": ""
  },
  -3151: {
    "text": "Position compare memory allocation failed",
    "description": ""
  },
  -3152: {
    "text": "Position compare buffer empty",
    "description": ""
  },
  -3153: {
    "text": "Failed to start position compare task",
    "description": ""
  },
  -3154: {
    "text": "Position compare buffer full",
    "description": ""
  },
  -3155: {
    "text": "Invalid DOUT for position compare",
    "description": ""
  },
  -3156: {
    "text": "Motor moving away from compare position",
    "description": ""
  },
  -3157: {
    "text": "Position compare internal inconsistence error",
    "description": ""
  },
  -3160: {
  ...
  -3161: {
    "text": "No position updated in Fpga",
    "description": ""
  },
  -4000: {
