...
class DataControl(baseControl):
    async def get_programmable_memory_scope(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_ranges_for_memory_scope(self, memory_scope, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def prepare_download(self, memory_scope, hw_module: ModuleType=None, number=None, subcomponent=None):
        """Prepares the device for download."""
        command = f"DOWNLOAD PREPARE"
        if hw_module:
            command += f" MODULE={hw_module.value}"
        if number is not None:
            command += f" NUMBER={number}"
    ...
    async def start_download_block(self, offset, size, hw_module: ModuleType=None, number=None, subcomponent=None):
        """Starts downloading a block of data."""
        command = f"DOWNLOAD BLOCK START"
        if hw_module:
            command += f" MODULE={hw_module.value}"
        if number is not None:
            command += f" NUMBER={number}"
    ...
    async def end_download_block(self, hw_module: ModuleType=None, number=None, subcomponent=None):
        """Ends the download of a block of data."""
        command = f"DOWNLOAD BLOCK END"
        if hw_module:
            command += f" MODULE={hw_module.value}"
        if number is not None:
            command += f" NUMBER={number}"
    ...
    async def get_download_sections(self, hw_module: ModuleType=None, number=None, subcomponent=None):
        """Gets the available download sections."""
        command = f"#DOWNLOAD SECTION NAME"
        if hw_module:
            command += f" MODULE={hw_module.value}"
        if number is not None:
            command += f" NUMBER={number}"
    ...
    async def start_download_section(self, section_name, size, hw_module: ModuleType=None, number=None, subcomponent=None):
        """Starts downloading a specific section."""
        command = f"DOWNLOAD SECTION START"
        if hw_module:
            command += f" MODULE={hw_module.value}"
        if number is not None:
            command += f" NUMBER={number}"
    ...
    async def end_download_section(self, hw_module: ModuleType=None, number=None, subcomponent=None):
        """Ends the download of a section."""
        command = f"DOWNLOAD SECTION END"
        if hw_module:
            command += f" MODULE={hw_module.value}"
        if number is not None:
            command += f" NUMBER={number}"
    ...
    async def finalize_download(self, hw_module: ModuleType=None, number=None, subcomponent=None):
        """Finalizes the download process."""
        command = f"DOWNLOAD FINISH"
        if hw_module:
            command += f" MODULE={hw_module.value}"
        if number is not None:
            command += f" NUMBER={number}"
    ...
    async def clear_error_stack(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_error_index_range(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_current_max_error_index(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_error(self, index, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_hardware_version(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_available_sub_modules(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_expected_sub_modules(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_available_functions(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_limit_value(self, name, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_double_limit_value(self, name, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def set_interval(self, message_type: InstrumentMessageType, interval):
        ...
        return await self.send_command(f"MESSAGE TYPE={message_type.value.upper()} TIME_INTERVAL={interval}")
    ...
    async def get_upload_memory_scope(self, hwModule: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_ranges_for_upload_memory_scope(self, memory_scope, hwModule: ModuleType=None, number=None, subcomponent=None):
        """Gets the ranges for an upload memory scope."""
        target_string = self._create_target_string(hwModule, number, subcomponent)
        return await self.send_command(f"#UPLOAD{target_string} TYPE={memory_scope}")

    async def prepare_upload(self, memory_scope, hwModule: ModuleType=None, number=None, subcomponent=None):
    ...
    async def upload_block(self, offset, size, timeout, hwModule: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_upload_sections(self, hwModule: ModuleType=None, number=None, subcomponent=None):
        """Gets the available upload sections."""
        target_string = self._create_target_string(hwModule, number, subcomponent)
        response = await self.send_command(f"#UPLOAD SECTION{target_string} NAME")
        return response

    async def upload_section(self, section_name, size, timeout, hwModule: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_upload_section_size(self, section_name, hwModule: ModuleType=None, number=None, subcomponent=None):
