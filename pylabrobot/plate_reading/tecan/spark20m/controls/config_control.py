...
class ConfigControl(baseControl):
  ...
  async def set_config_sap_instrument_serial_number(
    self, serial_number, module: Optional[ModuleType] = None, sub_module=None
  ):
  ...
  async def set_config_module_serial_number(
    self, serial_number, module: ModuleType, module_number, sub_module=None
  ):
  ...
  async def set_config_limit_value(
    self, value, name, hw_module: Optional[ModuleType] = None, number=None, subcomponent=None
  ):
  ...
  async def _get_objective_config(
    self, index, param, hw_module: ModuleType = ModuleType.FLUORESCENCE_IMAGING, number=1
  ):
  ...
  async def _set_objective_config(
    self, index, param, value, hw_module: ModuleType = ModuleType.FLUORESCENCE_IMAGING, number=1
  ):
  ...
  async def get_objective_roi_offset_x(
    self, hw_module: ModuleType = ModuleType.FLUORESCENCE_IMAGING, number=1
  ):
  ...
  async def set_objective_roi_offset_x(
    self, value, hw_module: ModuleType = ModuleType.FLUORESCENCE_IMAGING, number=1
  ):
    return await self.send_command(
  ...
  async def set_dead_time_config(
    self, deadTime, hwModule: Optional[ModuleType] = None, number=None, subcomponent=None
  ):
