...
class SensorControl(baseControl):
    ...
    async def get_motors(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def check_step_loss(self, motor=None, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_step_loss_result(self, motor=None, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def check_lid(self, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_firmware_counter(self, counter_name, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_software_counter(self, counter_name, hw_module: ModuleType=None, number=None, subcomponent=None):
        """Gets the value of a software counter."""
        command = f"?SW_COUNTER"
        if hw_module:
            command += f" MODULE={hw_module.value}"
        if number is not None:
            command += f" NUMBER={number}"
    ...
    async def set_software_counter(self, counter_name, value, hw_module: ModuleType=None, number=None, subcomponent=None):
    ...
    async def get_module_counter(self, counter, module: ModuleType):
        ...
        return await self.send_command(
            f"?COUNTER {counter} MODULE={module.value}"
        )
    ...
    async def _get_sensor_range(self, option, hw_module: ModuleType=None, number=None):
    ...
    async def get_all_sensor_groups(self, hw_module: ModuleType=None, number=None):
    ...
    async def get_temperature_sensors(self, hw_module: ModuleType=None, number=None):
    ...
    async def get_temperature_time_interval_range(self):
        ...
        return await self.send_command(f"#MESSAGE TYPE={InstrumentMessageType.TEMPERATURE.value} TIME_INTERVAL")
    ...
    async def set_temperature_time_interval(self, interval):
        ...
        return await self.send_command(f"MESSAGE TYPE={InstrumentMessageType.TEMPERATURE.value} TIME_INTERVAL={interval}")
