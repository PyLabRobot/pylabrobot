...
def get_child_location(resource: Resource) -> Coordinate:
  ...
  location = {
    ...
    90.0: Coordinate(x=resource.get_absolute_size_x(), y=0, z=0),
    180.0: Coordinate(x=resource.get_absolute_size_x(), y=resource.get_absolute_size_y(), z=0),
    270.0: Coordinate(x=0, y=resource.get_absolute_size_y(), z=0),
