...
from pylabrobot.resources import TipRack, TipSpot, create_equally_spaced


class TecanTipRack(TipRack):
...
def Adapter_96_DiTi_MCA384(name: str) -> TecanTipRack:
  ...
  return TecanTipRack(
    ...
    items=create_equally_spaced(TipSpot,
      num_items_x=12,
      num_items_y=8,
      dx=7.699999999999999,
      dy=4.199999999999999,
      dz=15.9,
      item_size_x=9.0,
      item_size_y=9.0,
    ),
...
def DiTi_100ul_Filter_MCA96(name: str) -> TecanTipRack:
  ...
  return TecanTipRack(
    ...
    items=create_equally_spaced(TipSpot,
      num_items_x=12,
      num_items_y=8,
      dx=6.300000000000001,
      dy=5.800000000000001,
      dz=43.1,
      item_size_x=9.0,
      item_size_y=9.0,
    ),
...
def Base_Nested_DiTi_MCA96(name: str) -> TecanTipRack:
  ...
  return TecanTipRack(
    ...
    items=create_equally_spaced(TipSpot,
      num_items_x=4,
      num_items_y=4,
      dx=-3.5999999999999996,
      dy=-3.6999999999999993,
      dz=43.1,
      item_size_x=33.0,
      item_size_y=33.0,
    ),
...
def Adapter_96_DiTi_1to1_MCA384(name: str) -> TecanTipRack:
  ...
  return TecanTipRack(
    ...
    items=create_equally_spaced(TipSpot,
      num_items_x=12,
      num_items_y=8,
      dx=7.449999999999999,
      dy=3.9499999999999993,
      dz=25.2,
      item_size_x=9.5,
      item_size_y=9.5,
    ),
...
def DiTi_125ul_Filter_MCA384(name: str) -> TecanTipRack:
  ...
  return TecanTipRack(
    name=name,
    size_x=127.30000000000001,
    size_y=85.30000000000001,
    size_z=20.0,
