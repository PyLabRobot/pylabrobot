...
def DiTi_100ul_Te_MO_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=42.0, maximal_volume=110.0, tip_type=TipType.DITI
  )
...
def DiTi_50ul_Te_MO_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=28.0, maximal_volume=60.0, tip_type=TipType.DITI
  )
...
def DiTi_200ul_Te_MO_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=42.0, maximal_volume=220.0, tip_type=TipType.DITI
  )
...
def DiTi_100ul_Filter_Te_MO_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=42.0, maximal_volume=90.0, tip_type=TipType.DITI
  )
...
def DiTi_200ul_Filter_Te_MO_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=42.0, maximal_volume=170.0, tip_type=TipType.DITI
  )
...
def Adapter_96_DiTi_MCA384_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=15.9, maximal_volume=110.0, tip_type=TipType.DITI
  )
...
def DiTi_100ul_Filter_MCA96_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=43.1, maximal_volume=90.0, tip_type=TipType.DITI
  )
...
def DiTi_100ul_MCA96_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=43.1, maximal_volume=110.0, tip_type=TipType.DITI
  )
...
def DiTi_200ul_Filter_MCA96_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=43.1, maximal_volume=170.0, tip_type=TipType.DITI
  )
...
def DiTi_200ul_MCA96_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=43.1, maximal_volume=220.0, tip_type=TipType.DITI
  )
...
def DiTi_50ul_MCA96_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=29.6, maximal_volume=60.0, tip_type=TipType.DITI
  )
...
def Adapter_96_DiTi_1to1_MCA384_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=25.2, maximal_volume=110.0, tip_type=TipType.DITI
  )
...
def DiTi_200ul_w_b_filter_MCA96_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=43.1, maximal_volume=175.0, tip_type=TipType.DITI
  )
...
def DiTi_500ul_Filter_SBS_MCA96_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=54.0, maximal_volume=405.0, tip_type=TipType.DITI
  )
...
def DiTi_500ul_SBS_MCA96_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=54.0, maximal_volume=502.0, tip_type=TipType.DITI
  )
...
def DiTi_200ul_SBS_LiHa_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-5.0, maximal_volume=220.0, tip_type=TipType.DITI
  )
...
def DiTi_50ul_SBS_LiHa_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-5.3, maximal_volume=55.0, tip_type=TipType.DITI
  )
...
def DiTi_125ul_Filter_MCA384_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=47.3, maximal_volume=115.0, tip_type=TipType.DITI
  )
...
def DiTi_125ul_MCA384_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=47.3, maximal_volume=129.0, tip_type=TipType.DITI
  )
...
def DiTi_15ul_Filter_MCA384_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=28.6, maximal_volume=18.0, tip_type=TipType.DITI
  )
...
def DiTi_15ul_MCA384_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=28.6, maximal_volume=19.0, tip_type=TipType.DITI
  )
...
def DiTi_50ul_Filter_MCA384_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=41.4, maximal_volume=44.0, tip_type=TipType.DITI
  )
...
def DiTi_50ul_MCA384_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=41.4, maximal_volume=53.0, tip_type=TipType.DITI
  )
...
def DiTi_10ul_Filter_LiHa_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-31.3, maximal_volume=12.0, tip_type=TipType.DITI
  )
...
def DiTi_10ul_LiHa_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-31.3, maximal_volume=23.0, tip_type=TipType.DITI
  )
...
def DiTi_200ul_Filter_LiHa_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-5.0, maximal_volume=210.0, tip_type=TipType.DITI
  )
...
def DiTi_350ul_Nested_LiHa_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-5.0, maximal_volume=390.0, tip_type=TipType.DITI
  )
...
def DiTi_10ul_Filter_LiHa_L_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-28.1, maximal_volume=12.0, tip_type=TipType.DITI
  )
...
def DiTi_10ul_LiHa_L_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-28.1, maximal_volume=23.0, tip_type=TipType.DITI
  )
...
def DiTi_1000ul_W_B_Filter_LiHa_tip() -> TecanTip:
  ...
  return TecanTip(
    has_filter=False, total_tip_length=32.0, maximal_volume=995.0, tip_type=TipType.DITI
  )
...
def DiTi_50ul_CL_LiHa_tip() -> TecanTip:
  ...
  print("Please get in touch at https://discuss.pylabrobot.org")
  return TecanTip(
    has_filter=False, total_tip_length=-5.3, maximal_volume=60.0, tip_type=TipType.DITI
  )
