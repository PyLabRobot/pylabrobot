...
from pylabrobot.resources.corning_costar.plates import Cos_96_wellplate_360ul_Fb
...
class TestOTDeck(unittest.TestCase):
  ...
  def setUp(self) -> None:
    ...
    self.deck.assign_child_at_slot(Cos_96_wellplate_360ul_Fb("my_plate"), 4)
    self.deck.assign_child_at_slot(Cos_96_wellplate_360ul_Fb("my_other_plate"), 5)
