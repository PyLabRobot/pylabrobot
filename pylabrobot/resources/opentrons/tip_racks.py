...
def eppendorf_96_tiprack_1000ul_eptips(name: str) -> TipRack:
  return cast(
    ...
    load_shared_opentrons_resource(
      definition="eppendorf_96_tiprack_1000ul_eptips", name=name, version=1
    ),
  )
...
def opentrons_96_filtertiprack_10ul(name: str) -> TipRack:
  return cast(
    TipRack,
    load_shared_opentrons_resource(
      definition="opentrons_96_filtertiprack_10ul", name=name, version=1
    ),
  )
...
def opentrons_96_filtertiprack_200ul(name: str) -> TipRack:
  return cast(
    TipRack,
    load_shared_opentrons_resource(
      definition="opentrons_96_filtertiprack_200ul", name=name, version=1
    ),
  )
...
def eppendorf_96_tiprack_10ul_eptips(name: str) -> TipRack:
  return cast(
    TipRack,
    load_shared_opentrons_resource(
      definition="eppendorf_96_tiprack_10ul_eptips", name=name, version=1
    ),
  )
...
def opentrons_96_filtertiprack_1000ul(name: str) -> TipRack:
  return cast(
    TipRack,
    load_shared_opentrons_resource(
      definition="opentrons_96_filtertiprack_1000ul", name=name, version=1
    ),
  )
...
def opentrons_96_filtertiprack_20ul(name: str) -> TipRack:
  return cast(
    TipRack,
    load_shared_opentrons_resource(
      definition="opentrons_96_filtertiprack_20ul", name=name, version=1
    ),
  )
