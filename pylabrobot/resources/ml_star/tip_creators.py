...
class HamiltonTip(Tip):
    ...
    def __init__(
        ...
        if fitting_depth is None:
            fitting_depth = {None: 0, 0: 0, 1: 8, 2: 8, 3: 8, 4: 7.55, 5: 10}[tip_size.value]
        else:
    ...
    def serialize(self):
        ...
        return {**super_serialized, "pickup_method": self.pickup_method.name, "tip_size": self.tip_size.name}
