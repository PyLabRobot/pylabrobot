...
def PLT_CAR_P3AC_A00(name: str) -> PlateCarrier:
    ...
    return PlateCarrier(
        ...
        size_z=130.0,
        sites=create_homogeneous_carrier_sites(
            [Coordinate(43.85, 37.5, 86.15), Coordinate(43.85, 183.5, 86.15), Coordinate(43.85, 329.5, 86.15)],
            site_size_x=86.0,
            site_size_y=127.0,
        ),
...
def PLT_CAR_P3AC_A01(name: str) -> PlateCarrier:
    ...
    return PlateCarrier(
        ...
        size_z=130.0,
        sites=create_homogeneous_carrier_sites(
            [Coordinate(44.1, 37.5, 85.9), Coordinate(44.1, 183.5, 85.9), Coordinate(44.1, 329.5, 85.9)],
            site_size_x=86.0,
            site_size_y=127.0,
        ),
...
def PLT_CAR_P3HD(name: str) -> PlateCarrier:
    ...
    return PlateCarrier(
        ...
        size_z=130.0,
        sites=create_homogeneous_carrier_sites(
            [Coordinate(43.9, 27.05, 117.65), Coordinate(43.9, 173.05, 117.65), Coordinate(43.9, 319.05, 117.65)],
            site_size_x=86.0,
            site_size_y=127.0,
        ),
        model="PLT_CAR_P3HD",
...
def PLT_CAR_P3MD(name: str) -> PlateCarrier:
    ...
    return PlateCarrier(
        ...
        size_z=130.0,
        sites=create_homogeneous_carrier_sites(
            [Coordinate(44.1, 37.5, 111.5), Coordinate(44.1, 183.5, 111.5), Coordinate(44.1, 329.5, 111.5)],
            site_size_x=86.0,
            site_size_y=127.0,
        ),
        model="PLT_CAR_P3MD",
...
def MFX_CAR_PCR96_PCR384_3Empty(name: str) -> PlateCarrier:
    """ """
    return PlateCarrier(
        name=name,
        size_x=135.0,
        ...
        size_z=130.0,
        sites=create_homogeneous_carrier_sites(
            [Coordinate(x=4.0, y=296.5, z=115.9), Coordinate(x=4.0, y=392.5, z=109.5)],
            site_size_x=127.0,
            site_size_y=86.0,
        ),
        model="MFX_CAR_PCR96_PCR384_3Empty",
    )


def MFX_CAR_3PCR384(name: str) -> PlateCarrier:
    """ """
    return PlateCarrier(
        name=name,
        size_x=112.5,
        ...
        sites=create_homogeneous_carrier_sites(
            [
                Coordinate(x=22.0, y=37.5, z=115.9),
                Coordinate(x=22.0, y=183.5, z=115.9),
                Coordinate(x=22.0, y=329.5, z=115.9),
            ],
            site_size_x=86.0,
            site_size_y=127.0,
        ),
        model="MFX_CAR_3PCR384",
    )
