...
from pylabrobot.legacy.plate_reading.molecular_devices.spectramax_gemini_em_backend import (
...
class TestMolecularDevicesSpectraMaxGeminiEMBackend(unittest.IsolatedAsyncioTestCase):
  ...
  def test_public_imports(self):
    from pylabrobot.legacy.plate_reading import (
      MolecularDevicesSpectraMaxGeminiEMBackend as PlateReadingGeminiBackend,
    )
    from pylabrobot.legacy.plate_reading.molecular_devices import (
