...
the :class:`~pylabrobot.legacy.centrifuge.Centrifuge` returned here is *not*
paired with a separate :class:`~pylabrobot.legacy.centrifuge.Loader` (unlike the
...
from pylabrobot.legacy.centrifuge.centrifuge import Centrifuge
from pylabrobot.legacy.centrifuge.highres.microspin_backend import MicroSpinBackend
...
def MicroSpin(
  ...
  Returns:
    A :class:`~pylabrobot.legacy.centrifuge.Centrifuge` wired to a
