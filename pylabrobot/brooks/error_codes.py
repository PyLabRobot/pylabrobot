...
Older GPL systems may display the license number shown above in ( ) rather than the name. The currently installed licenses can be viewed via the web interface by selecting Utilities>Controller Options or by accessing DataID 112, "Software license option bits".  To obtain a required license, contact your system administrator or Brooks.""",
  ...
  -500: {
    "text": "Device I/O error",
    "description": "An I/O operation has failed. This is a generic error code that is used when an I/O operation fails but no specific information is available.",
  },
  -501: {
    "text": "No I/O pending",
    "description": "A read data operation was initiated in a situation where I/O is normally expected, but no data is available.",
  },
  -502: {
    "text": "No message buffers available",
    "description": "An I/O operation cannot allocate internal buffers in a situation where buffers should always be available.",
  },
  -503: {
    "text": "Node not found",
    "description": "An Ethernet slave controller node or a RS-485 serial bus board is configured but could not be found.",
  },
  -504: {
    "text": "Less data than expected",
    "description": "An I/O operation has returned less data than required. This error should normally not be seen.",
  },
  -505: {
    "text": "Unexpected end of file",
    "description": "The end of a data file has been encountered before it was expected. Normally this means the data file has been corrupted.",
  },
  -506: {
    "text": "Input too long",
    "description": "An I/O operation or the GPL compiler has received more input than it can handle.",
  },
  -507: {
    "text": "Output too long",
    "description": "Indicates that the output generated by the command being executed contained too much data.",
  },
  -508: {
    "text": "File not found",
    "description": "You have specified a file that does not exist. Verify that the file name is spelled correctly.",
  },
  -509: {
    "text": "Can't open file for write",
    "description": "You have specified a file for writing that cannot be opened.",
  },
  -510: {
    "text": "File already exists",
    "description": "You have attempted to create a file that already exists.",
  },
  -511: {
    "text": "Can't create directory",
    "description": "An attempt to create a directory has failed. Normally this error should not occur.",
  },
  -512: {
    "text": "Error writing file",
    "description": "A write operation to a device or file has failed.",
  },
  -513: {
    "text": "Error reading file",
    "description": "A read operation from a device or a file has failed.",
  },
  -514: {
    "text": "Buffer already in use",
    "description": "An attempt has been made to use an I/O buffer that is already in use.",
  },
  -515: {
    "text": "Invalid input character",
    "description": "An invalid ASCII character has been encountered while compiling a GPL program.",
  },
  -516: {
    "text": "Invalid file name",
    "description": "A file name string is invalid. It may contain invalid characters or may not have the proper directory path format.",
  },
  -517: {
    "text": "File path too long",
    "description": "The total file path and name string you have specified is too long.",
  },
  -518: {
    "text": "Invalid data checksum",
    "description": "A data file or message that is validated by a checksum does not have a correct checksum value.",
  },
  -519: {
    "text": "Invalid file format",
    "description": "The format of a data file does not match what is expected.",
  },
  -520: {
    "text": "File not open",
    "description": "You have attempted to perform a file operation on a file that is not open.",
  },
  -521: {
    "text": "Invalid file type",
    "description": "You have attempted to access a file in a way that is not allowed for the type of file.",
  },
  -522: {
    "text": "File interlocked",
    "description": "You have attempted to access a file that is already in use.",
  },
  -523: {
    "text": "No data available",
    "description": "A polling I/O request has failed because no data is available.",
  },
  -524: {
    "text": "No timestamp available",
    "description": "A request has been made to read the timestamp for an I/O request when none is available.",
  },
  -525: {
    "text": "Latch input overrun",
    "description": "The hardware latch circuit has detected that edges in the latch input signal are occurring too quickly to be processed.",
  },
  -526: {
    "text": "Latch data overrun",
    "description": "Latch events are occurring too quickly for the Precise Controller to service them.",
  },
  -527: {
    "text": "Invalid latch configuration",
    "description": "A value in DataID 16100 'Latch DIN' has been specified that is not valid for the controller configuration.",
  },
  -700: {
