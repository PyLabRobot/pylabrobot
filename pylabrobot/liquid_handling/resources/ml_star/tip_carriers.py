...
class TIP_CAR_288_HTF_B00(TipCarrier):
...
class TIP_CAR_120BC_4mlTF_A00(TipCarrier):
...
class TIP_CAR_NTR_A00(TipCarrier):
...
class TIP_CAR_288_ST_B00(TipCarrier):
...
class TIP_CAR_384_TIP_50ul_A00(TipCarrier):
...
class TIP_CAR_384BC_HT_A00(TipCarrier):
...
class TIP_CAR_384BC_HTF_A00(TipCarrier):
...
class TIP_CAR_480BC_LT_A00(TipCarrier):
...
class TIP_CAR_480BC_ST_A00(TipCarrier):
...
class TIP_CAR_480BC_HTF_A00(TipCarrier):
...
class TIP_CAR_384_LTF_A00(TipCarrier):
...
class TIP_CAR_384BC_TIP_50ulF_A00(TipCarrier):
...
class TIP_CAR_480BC_PiercingTips_A00(TipCarrier):
...
class TIP_CAR_480BC_PiercingTip150ulFilter_A00(TipCarrier):
...
class TIP_CAR_480_HTF_A00(TipCarrier):
...
class TIP_CAR_384_HT_A00(TipCarrier):
...
class TIP_CAR_288_LT_B00(TipCarrier):
...
class TIP_CAR_480BC_SlimTips300ulFilter_A00(TipCarrier):
...
class TIP_CAR_96BC_4mlTF_A00(TipCarrier):
...
class TIP_CAR_288_ST_A00(TipCarrier):
...
class TIP_CAR_480_ST_A00(TipCarrier):
...
class TIP_CAR_288_HTF_A00(TipCarrier):
...
class TIP_CAR_384_A00(TipCarrier):
...
class TIP_CAR_288_HTF_C00(TipCarrier):
...
class TIP_CAR_384_STF_A00(TipCarrier):
...
class TIP_CAR_96BC_5mlT_A00(TipCarrier):
...
class TIP_CAR_288_ST_C00(TipCarrier):
...
class TIP_CAR_288_TIP_50ulF_C00(TipCarrier):
...
class TIP_CAR_288_LT_C00(TipCarrier):
...
class TIP_CAR_480_LT_A00(TipCarrier):
...
class TIP_CAR_72_5mlT_C00(TipCarrier):
...
class TIP_CAR_288_LT_A00(TipCarrier):
...
class TIP_CAR_480BC_LTF_A00(TipCarrier):
...
class TIP_CAR_384BC_A00(TipCarrier):
...
class TIP_CAR_288_STF_C00(TipCarrier):
...
class TIP_CAR_480_LTF_A00(TipCarrier):
...
class TIP_CAR_288_STF_A00(TipCarrier):
...
class TIP_CAR_288_LTF_B00(TipCarrier):
...
class TIP_CAR_480_HT_A00(TipCarrier):
...
class TIP_CAR_480_TIP_50ul_A00(TipCarrier):
...
class TIP_CAR_288_B00(TipCarrier):
...
class TIP_CAR_384_TIP_50ulF_A00(TipCarrier):
  """ Tip carrier with 4 50ul tip with filter racks landscape  [revision A00] """
...
class TIP_CAR_288_HT_A00(TipCarrier):
...
class TIP_CAR_480_TIP_50ulF_A00(TipCarrier):
...
class TIP_CAR_288_HT_C00(TipCarrier):
...
class TIP_CAR_384BC_LTF_A00(TipCarrier):
...
class TIP_CAR_384BC_STF_A00(TipCarrier):
...
class TIP_CAR_384BC_LT_A00(TipCarrier):
...
class TIP_CAR_480BC_HT_A00(TipCarrier):
...
class TIP_CAR_288_STF_B00(TipCarrier):
...
class TIP_CAR_384BC_TIP_50ul_A00(TipCarrier):
  """ Tip carrier with 4 50ul tip racks landscape  [revision A00] """
...
class TIP_CAR_72_4mlTF_C00(TipCarrier):
...
class TIP_CAR_480BC_A00(TipCarrier):
...
class TIP_CAR_480BC_TIP_50ul_A00(TipCarrier):
  """ Tip carrier with 5 50ul tip racks landscape  [revision A00] """
...
class TIP_CAR_384_ST_A00(TipCarrier):
...
class TIP_CAR_480BC_TIP_50ulF_A00(TipCarrier):
  """ Tip carrier with 5 50ul tip with filter racks landscape  [revision A00] """
...
class TIP_CAR_480_STF_A00(TipCarrier):
...
class TIP_CAR_288_HT_B00(TipCarrier):
...
class TIP_CAR_288_A00(TipCarrier):
...
class TIP_CAR_384_LT_A00(TipCarrier):
...
class TIP_CAR_480_A00(TipCarrier):
  """ Carrier for 5 Racks with 96 Tips landscape [revision A00] """
...
class TIP_CAR_288_LTF_A00(TipCarrier):
...
class TIP_CAR_120BC_5mlT_A00(TipCarrier):
...
class TIP_CAR_288_LTF_C00(TipCarrier):
...
class TIP_CAR_480BC_STF_A00(TipCarrier):
...
class TIP_CAR_480BC_SlimTips_A00(TipCarrier):
...
class TIP_CAR_288_C00(TipCarrier):
...
class TIP_CAR_384BC_ST_A00(TipCarrier):
  """ Tip carrier with 4 standard volume tip with filter racks for 12/16 channel instruments """
