...
from pylabrobot.liquid_handling.backends.hamilton.star.backend_96head import (
  STARBackend96HeadMixin,
)
...
from pylabrobot.liquid_handling.backends.hamilton.star.shared import (  # noqa: F401
  Head96Information,
  STARBaseMixin,
...
class STARBackend(STARBackend96HeadMixin, HamiltonLiquidHandler, HamiltonHeaterShakerInterface):
  ...
  async def setup(
    ...
    async def set_up_arm_modules():
      await set_up_pip()
      await set_up_iswap()
      await self._setup_96_head(skip=skip_core96_head)
