...
class EVOTests(unittest.IsolatedAsyncioTestCase):
  async def asyncSetUp(self) -> None:
    ...
    self.evo.send_command = unittest.mock.AsyncMock()
    ...
    self.evo.setup = unittest.mock.AsyncMock()
  ...
  async def test_pick_up_tip(self):
    ...
    self.evo.send_command.assert_has_calls([
      ...
      call(module="C5", command="PAA", params=[2380, 1991, 90, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000]),
