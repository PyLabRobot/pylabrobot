...
from pylabrobot.liquid_handling.backends.agilent.bravo.protocol.commands import CommandID, DEFAULT_COMMAND_TIMEOUT_MS, MAX_COMMAND_RETRIES
...
class V11DeviceComm:
        ...
        for attempt in range(1, MAX_COMMAND_RETRIES + 1):
            try:
                ...
                logger.warning(
                    ...
                    command_id, attempt, MAX_COMMAND_RETRIES, exc,
                )
    ...
    def _send_once(
        ...
        length_bytes = self._transport.receive_exact(
            _LENGTH_HEADER_SIZE, timeout_ms,
        )
