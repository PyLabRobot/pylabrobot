...
WAXIS_PARAM_TABLE: tuple[WAxisParamEntry, ...] = (
  ...
  WAxisParamEntry(
    ParamDBs.I2T_CONT_CURRENT, ST96=0.09127, ST384=0.09127, LT=0.09127, AM=0.0943, F96_50=0.09127
  ),
  ...
  WAxisParamEntry(
    ParamDBs.HOMING_POS, ST96=0.1774625, ST384=0.1774625, LT=0.206, AM=0.19921875, F96_50=0.306875
  ),
  ...
  WAxisParamEntry(
    ParamDBs.STATIONARY_VEL_DTERM, ST96=0.002, ST384=0.002, LT=0.00125, AM=0.00175, F96_50=0.002
  ),
  WAxisParamEntry(
  ...
  WAxisParamEntry(
    ParamDBs.STATIONARY_POS_DTERM, ST96=0.00075, ST384=0.00075, LT=0.0025, AM=0.001, F96_50=0.00075
  ),
  WAxisParamEntry(ParamDBs.STATIONARY_MAX_ERROR, ST96=0.0, ST384=0.0, LT=0.0, AM=0.0, F96_50=0.0),
  WAxisParamEntry(
    ParamDBs.SM_THRESHOLD, ST96=0.052875, ST384=0.0125, LT=0.056, AM=0.048125, F96_50=0.052875
  ),
  ...
  WAxisParamEntry(
    ParamDBs.SM_STATIONARY_VEL_DTERM, ST96=0.002, ST384=0.0015, LT=0.003, AM=0.00175, F96_50=0.002
  ),
  WAxisParamEntry(
    ParamDBs.SM_STATIONARY_POS_PTERM, ST96=650.0, ST384=780.0, LT=1500.0, AM=550.0, F96_50=750.0
  ),
  WAxisParamEntry(
    ParamDBs.SM_STATIONARY_POS_ITERM, ST96=48.0, ST384=75.0, LT=125.0, AM=100.0, F96_50=48.0
  ),
  WAxisParamEntry(
    ParamDBs.SM_STATIONARY_POS_DTERM, ST96=0.001, ST384=0.00075, LT=0.00115, AM=0.001, F96_50=0.001
  ),
  WAxisParamEntry(
  ...
  *,
  ...
  for entry in WAXIS_PARAM_TABLE:
    ...
    if entry.param in _UINT_PARAMS:
      params.write_uint(int(entry.param), int(value), timeout_ms=per_param_timeout_ms)
    else:
      params.write_float(int(entry.param), value, timeout_ms=per_param_timeout_ms)
