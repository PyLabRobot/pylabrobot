...
| Manufacturer | Machine | Features | PLR-Support | Links |
|--------------|---------|----------|-------------|--------|
| Micronic | Code Reader Software / IO Monitor HTTP server, or direct local TWAIN + serial control | <span class="badge badge-reading">rack reading</span><span class="badge badge-reading">barcode scanning</span> | Basics | [PLR](https://docs.pylabrobot.org/user_guide/micronic/index.html) / [OEM](https://www.micronic.com/products/code-reader/) |
