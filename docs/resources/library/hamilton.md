...
| 'NTR4 module'<br>Part no.: 191425<br>Module to position a stack of up to 4x 96 nested tip racks (NTR). Occupies one MFX site. | | `hamilton_mfx_module_tiprackholder_ntr` |
