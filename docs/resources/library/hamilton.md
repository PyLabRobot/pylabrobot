...
| Hamilton 96 solid CO-RE II tip support.<br>Hamilton name: `Core96_TipSupport` (CO-RE II)<br>Part number: 6608647<br>Takes the tips it holds as `make_tip`. | | `hamilton_96_tiprack_solid_coreii` |
| Hamilton 96 solid CO-RE I tip support.<br>Hamilton name: `Core96_TipSupport` (CO-RE I)<br>The CO-RE II support's generation before, its spots 3.5 mm lower.<br>Takes the tips it holds as `make_tip`. | | `hamilton_96_tiprack_solid_corei` |
