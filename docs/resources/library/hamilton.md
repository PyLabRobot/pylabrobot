...
| 'TIP_CAR_NTR_A00'<br>Part no.: 182074<br>Carrier for 5 stacks of up to 4x 96 nested tip racks (NTR) (6T) | | `hamilton_tip_carrier_L5_ntr_a00` |
...
| Description | Image | PLR definition |
| - | - | - |
| 'MFX_TIP_module'<br>Part no.: 188160<br>Module to position a high-, standard-, low volume or 5ml tip rack (but not a 384 tip rack) | ![](img/hamilton/MFX_TIP_module_188040.jpg) | `hamilton_mfx_tiprackholder_standard` |
| 'NTR4 module'<br>Part no.: 191425<br>Module to position a stack of up to 4x 96 nested tip racks (NTR). Occupies one MFX site. | | `hamilton_mfx_resourceholder_ntr` |
...
| Hamilton 96 nested tip rack (NTR) 10uL.<br>Hamilton name: `LT_L_NE_stack`<br>Part number: 235949 (non-sterile), 235971 (clear, non-sterile), 235983 (sterile)<br>[Hamilton website](https://www.hamiltoncompany.com/consumables-labware-accessories/co-re-and-co-re-ii-tips/10-μl-co-re-ii-tips) | | `hamilton_96_tiprack_10uL_NTR` |
...
| Hamilton 96 nested tip rack (NTR) 300uL.<br>Hamilton name: `ST_L_NE_stack`<br>Part number: 235950 (non-sterile), 235965 (clear, non-sterile), 235985 (sterile)<br>[Hamilton website](https://www.hamiltoncompany.com/consumables-labware-accessories/co-re-and-co-re-ii-tips/300-μl-co-re-ii-tips) | | `hamilton_96_tiprack_300uL_NTR` |
...
| Hamilton 96 raised CO-RE II tip rack.<br>Part number: 6608647<br>Thick, unbending body with no frame; holds its tips 16 mm above the holder it sinks into.<br>Takes the tips it holds as `make_tip`. | | `hamilton_96_tiprack_raised_core_ii` |
| Hamilton 96 raised CO-RE I tip rack.<br>The CO-RE II rack's generation before, holding its tips 3.5 mm lower.<br>Takes the tips it holds as `make_tip`. | | `hamilton_96_tiprack_raised_core_i` |
