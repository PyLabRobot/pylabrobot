...
| Description | Image | PLR definition |
| - | - | - |
| 'MFX_TIP_module'<br>Part no.: 188160 (Tip Module BC)<br>Module to position a high-, standard- or low volume framed tip rack (but not a 384 tip rack) | ![](img/hamilton/MFX_TIP_module_188040.jpg) | `hamilton_mfx_module_tiprackholder_standard` |
