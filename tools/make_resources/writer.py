...
def write_tip_rack_p(o, cname, description):
  _write_tip_rack_header(o, "TipRack", cname, description, with_params=False)
  base = cname[:-2] + "_L"
...
def _write_plate_header(o, base_class, name, description, with_params: bool,
  size_x=None, size_y=None, size_z=None, one_dot_max=None, lid_height=None, EqnOfVol=None):
  o.write(f'\n\n')
...
def write_plate_with_create_equally_spaced(o, base_class, name, description, size_x, size_y, size_z, dx, dy, dz, num_items_x, num_items_y, well_size_x, well_size_y, one_dot_max, lid_height=None, EqnOfVol=None):
  _write_plate_header(o, base_class, name, description, True, size_x, size_y, size_z, one_dot_max, lid_height, EqnOfVol)
...
def write_landscape_plate(o, cname, description):
  _write_plate_header(o, "Plate", cname, description, with_params=False)
  base = cname[:-2]
  o.write(f'  return {base}(name=name, with_lid=with_lid)\n')


def write_portrait_plate(o, cname, description):
  _write_plate_header(o, "Plate", cname, description, with_params=False)
  base = cname[:-2]
