...
from pylabrobot.utils.file_parsing import find_float, find_string, find_int
from tools.make_resources.maker import make


BASE_DIR = "./LabWare/ML_STAR"
BASE_CLASS = "MFXCarrier"
OUT_FILE = "flexcar.py"
...
def make_from_file(fn, o):
  ...
  o.write(f'    sites=create_homogeneous_carrier_sites([\n')
